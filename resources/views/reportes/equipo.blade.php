        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a  href="Ereport/{{$pID}}/{{$pTipo}}/{{$pDepartamento}}/{{$pItem}}/{{$pReference}}/{{$DateFrom}}/{{$pTo}}" type="button" class="btn btn-tool">
...
['{{__($dataS4->Proyecto)}}', {{__((number_format($dataS4->Importe, 2, '.', '')))}}],
@endforeach
]
}]
});

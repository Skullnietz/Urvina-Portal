                                ...
                                @else
                                    ...
                                    <table class="table table-striped rounded">
                                        ...
                                        <tr>
                                            ...
                                            <td class="border" style="text-align:right">{{$date1->toFormattedDateString();}}</td>

                                        </tr>
                                        <tr>
                                            <td class="border"> <b>{{__('A:')}}</b> </td>
                                            <td class="border" style="text-align:right"><span id="ultimo-dia-es">{{$date2->toFormattedDateString();}}</td>
                                        </tr>
                                    </table>
                                    <div class="row">

                            ...
                            <div class="row">
                                ...
                                <div class="col-11">
                                    ...
                                    <form action="{{route('additem', app()->getLocale())}}" method="get">
                                        ...
                                        <input type="hidden" name="existente" value="{{$item->Existente}}">
                                        @endforeach
                                    ...
                                    <div class="input-group input-group mb-3" style="margin-top:10px">
                                        ...
                                        <select  name="talla" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required>
                                            ...
                                            <option value="{{$key->Descripcion}}"> <b>{{$key->Descripcion}}</b> ({{number_format($key->Existencia)}} {{__('Disponibles')}})  </option>
                                            @endforeach
                                        </select>
                                      </div>
                                    @endif

            ...
            <div class="container d-flex align-items-center" >
                <div class="mx-auto">
                    <div style="position:relative;">
                        <a href="{{route('printpedido', [app()->getLocale(), $pedido->ID])}}" style="position:absolute; top:0; right:0; margin-top:-15px" class="btn btn-outline-dark"><i class="fas fa-print" ></i></a>
                      </div>
